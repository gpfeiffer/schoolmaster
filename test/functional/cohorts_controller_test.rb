...
class CohortsControllerTest < ActionController::TestCase
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post :create, cohort: { academic_id: @cohort.academic_id, code: @cohort.code, description: @cohort.description, name: @cohort.name }
    end
  ...
  test "should update cohort" do
    put :update, id: @cohort, cohort: { academic_id: @cohort.academic_id, code: @cohort.code, description: @cohort.description, name: @cohort.name }
    assert_redirected_to cohort_path(assigns(:cohort))
  end
